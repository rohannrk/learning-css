...
export default function DarkModeBrainrot() {
  ...
  return (
    <div className="relative h-full w-full flex items-center justify-center">
      <div className="relative z-10 h-100 w-100 bg-neutral-72 dark:bg-neutral-900 shadow-2xl border border-neutral-100 dark:border-neutral-800 rounded-xl overflow-hidden">
        ...
        <div className="p-4">
          <h2 className="font-bold text-neutral-600 dark:text-white text-[20px]">
            These LLMs are getting out of hand
          </h2>
          <p className="text-neutral-400 dark:text-neutral-300 text-[16px] mt-2">
          ...
          <button
            ...
            className="px-2 py-1 rounded-lg dark:bg-neutral-800 dark:text-white bg-neutral-100 text-[16px] text-neutral-500 mt-4 cursor-pointer"
          >
